...
purpose: "People — what it is, when to register one, and its key fields"
---
...
Email; `Function *`. Job Family is no longer picked here (2026-08-28): it derives from the
selected [Function](functions.md).
