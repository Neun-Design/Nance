...
purpose: "Product Groups — what it is, when to register one, and its key fields"
---

# Product Groups

**What it is:** a product variant defined by concrete spec values (e.g. "CT Contrast Adult |
Contrast: Yes, Age Group: Adult, Room Time: 30 min").
