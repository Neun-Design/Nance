...
The #359 round added the Tickets **Requirements** picker
(`manualRequirementsForTicket`: flagged + Active requirements passing the
party/geography gates with the product dimensions relaxed, minus the live
inherited set of the draft).
